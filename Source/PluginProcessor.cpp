...
#endif
{
    mainModel.reset(new MainModel());
    midiPlayer.reset(new MidiPlayer(*mainModel));
}
...
{
    return new KandinskyMusicPainterIIAudioProcessorEditor (*this, *mainModel, *midiPlayer);
}
